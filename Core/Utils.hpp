...
#define nothrow_default_constructible(Type, ...) std::is_nothrow_constructible_v<Type>
#define nothrow_constructible(Type, ...) std::is_nothrow_constructible_v<Type, __VA_ARGS__>
...
#define nothrow_forward_constructible(Type) ( \
    std::is_lvalue_reference_v<Type> ? nothrow_copy_constructible(std::remove_reference_t<std::remove_const_t<Type>>) : \
    std::is_rvalue_reference_v<Type> ? nothrow_move_constructible(std::remove_reference_t<std::remove_const_t<Type>>) : \
    std::is_move_constructible_v<std::remove_reference_t<std::remove_const_t<Type>>> ? \
        nothrow_move_constructible(std::remove_reference_t<std::remove_const_t<Type>>) : nothrow_copy_constructible(std::remove_reference_t<std::remove_const_t<Type>>) \
    )
...
#define nothrow_forward_assignable(Type) ( \
    std::is_lvalue_reference_v<Type> ? nothrow_copy_assignable(std::remove_reference_t<std::remove_const_t<Type>>) : \
    std::is_rvalue_reference_v<Type> ? nothrow_move_assignable(std::remove_reference_t<std::remove_const_t<Type>>) : \
    std::is_move_assignable_v<std::remove_reference_t<std::remove_const_t<Type>>> ? \
        nothrow_move_assignable(std::remove_reference_t<std::remove_const_t<Type>>) : nothrow_copy_assignable(std::remove_reference_t<std::remove_const_t<Type>>) \
    )
#define nothrow_destructible(Type) std::is_nothrow_destructible_v<Type>
#define nothrow_default_invocable(Function) std::is_nothrow_invocable_v<Function>
#define nothrow_invocable(Function, ...) std::is_nothrow_invocable_v<Function, __VA_ARGS__>
...
#define noexcept_default_constructible(Type) noexcept(nothrow_constructible(Type))
#define noexcept_constructible(Type, ...) noexcept(nothrow_constructible(Type, __VA_ARGS__))
...
#define noexcept_default_invocable(Function, ...) noexcept(nothrow_invocable(Function))
#define noexcept_invocable(Function, ...) noexcept(nothrow_invocable(Function, __VA_ARGS__))
