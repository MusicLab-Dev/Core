...
#define nothrow_invokable(Function, ...) std::is_nothrow_invokable_v<Function, __VA_ARGS__>
...
#define noexcept_invokable(Function, ...) noexcept(nothrow_invokable(Function, __VA_ARGS__))
